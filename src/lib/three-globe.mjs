import { Easing, Group as Group$1, Tween } from '@tweenjs/tween.js';
import accessorFn from 'accessor-fn';
import { max, sum } from 'd3-array';
import { color } from 'd3-color';
import { geoDistance as geoDistance$1, geoGraticule10, geoInterpolate } from 'd3-geo';
...
var GlobeLayerKapsule = Kapsule({
  ...
  stateInit: function stateInit() {
    ...
    // create graticules
    var graticulesObj = new THREE$h.LineSegments(
      new GeoJsonGeometry(geoGraticule10(), GLOBE_RADIUS, 2),
      new THREE$h.LineBasicMaterial({
        color: 'lightgrey',
        transparent: true,
        opacity: 0.1,
      }),
  ...
  update: function update(state, changedProps) {
    ...
    if (changedProps.hasOwnProperty('globeCurvatureResolution')) {
      ...
      (_state$globeObj$geome = state.globeObj.geometry) === null ||
        _state$globeObj$geome === void 0 ||
        _state$globeObj$geome.dispose();
    ...
    if (changedProps.hasOwnProperty('bumpImageUrl')) {
      if (!state.bumpImageUrl) {
        ...
        state.bumpImageUrl &&
          new THREE$h.TextureLoader().load(state.bumpImageUrl, function (texture) {
      ...
      value: function onRemoveObj(fn) {
        ...
        _superPropGet(
          ...
          function (obj, dId) {
            ...
            _classPrivateFieldGet2(_removeDelay, _this3)
              ? setTimeout(removeFn, _classPrivateFieldGet2(_removeDelay, _this3))
              : removeFn();
          },
        ]);
        return this;
...
var PointsLayerKapsule = Kapsule({
  ...
  update: function update(state, changedProps) {
    ...
    if (state.pointsMerge) {
      ...
      var pointsGeometry = !state.pointsData.length
        ? new THREE$f.BufferGeometry()
        : (BufferGeometryUtils$2.mergeGeometries || BufferGeometryUtils$2.mergeBufferGeometries)(
            state.pointsData.map(function (d) {
      ...
      var points = new THREE$f.Mesh(
        pointsGeometry,
        new THREE$f.MeshLambertMaterial({
          color: 0xffffff,
          transparent: true,
          vertexColors: true,
        }),
    ...
    function updateObj(obj, d) {
      var applyUpdate = function applyUpdate(td) {
        ...
        var globeCenter = state.pointsMerge
          ? new THREE$f.Vector3(0, 0, 0)
          : state.scene.localToWorld(new THREE$f.Vector3(0, 0, 0)); // translate from local to world coords
...
var invisibleUndergroundShaderExtend = function invisibleUndergroundShaderExtend(shader) {
  ...
  ).replace('void main() {', ['void main() {', 'vSurfaceRadius = surfaceRadius;', 'vPos = position;'].join('\n'));
  shader.fragmentShader = (
    'uniform float surfaceRadius;\nvarying float vSurfaceRadius;\nvarying vec3 vPos;\n' + shader.fragmentShader
  ).replace(
    'void main() {',
    ['void main() {', 'if (length(vPos) < max(surfaceRadius, vSurfaceRadius)) discard;'].join('\n'),
  );
  return shader;
};
...
var ArcsLayerKapsule = Kapsule({
  ...
  stateInit: function stateInit(_ref) {
    ...
    return {
      ...
      sharedMaterial: new THREE$e.ShaderMaterial(
        _objectSpread2(
          _objectSpread2({}, dashedLineShaders()),
          {},
          {
            transparent: true,
  ...
  update: function update(state) {
    ...
    state.dataMapper
      .onUpdateObj(function (group, arc) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          if (useTube) {
            ...
            obj.geometry = new THREE$e.TubeGeometry(
              curve,
              state.arcCurveResolution,
              stroke / 2,
    ...
    function calcCurve(_ref4) {
      ...
      if (altitude || startAlt || endAlt) {
        ...
        var curve = _construct(
          THREE$e.CubicBezierCurve3,
          _toConsumableArray([[].concat(startPnt, [startAlt]), m1Pnt, m2Pnt, [].concat(endPnt, [endAlt])].map(getVec)),
        );
        return curve;
      } else {
        // ground line
        ...
        return calcSphereArc.apply(
          void 0,
          _toConsumableArray([[].concat(startPnt, [_alt]), [].concat(endPnt, [_alt])].map(getVec)),
        );
      }
      ...
      function calcSphereArc(startVec, endVec) {
        ...
        var getGreatCirclePoint =
          angle === 0
            ? function () {
                return startVec.clone();
              } // points exactly overlap
            : function (t) {
                return new THREE$e.Vector3()
                  .addVectors(
      ...
      if (colors instanceof Array || colors instanceof Function) {
        var colorInterpolator =
          colors instanceof Array
            ? scaleLinear() // array of colors, interpolate at each step
                .domain(
...
var HexBinLayerKapsule = Kapsule({
  ...
  update: function update(state, changedProps) {
    ...
    if (state.hexBinMerge) {
      // merge points into a single mesh
      var hexPointsGeometry = !hexBins.length
        ? new THREE$d.BufferGeometry()
        : (BufferGeometryUtils$1.mergeGeometries || BufferGeometryUtils$1.mergeBufferGeometries)(
            hexBins.map(function (d) {
              var obj = state.dataMapper.getObj(d);
              ...
              geom.setAttribute(
                'color',
                array2BufferAttr(
                  _toConsumableArray(new Array(nVertices)).map(function (_, idx) {
    ...
    function updateObj(obj, d) {
      ...
      var geoJson =
        margin === 0
          ? obj.__hexGeoJson
          : obj.__hexGeoJson.map(function (_ref5) {
      ...
      var applyUpdate = function applyUpdate(td) {
        ...
        obj.geometry.setAttribute(
          'surfaceRadius',
          array2BufferAttr(Array(obj.geometry.getAttribute('position').count).fill(vertexSurfaceRadius), 1),
        );
      };
      var currentTargetD =
        obj.__currentTargetD ||
        ...
        [sideColor, topColor].forEach(function (color) {
          if (!hexMaterials.hasOwnProperty(color)) {
            ...
            hexMaterials[color] = applyShaderExtensionToMaterial(
              new THREE$d.MeshLambertMaterial({
                color: colorStr2Hex(color),
                transparent: opacity < 1,
                opacity: opacity,
                side: THREE$d.DoubleSide,
...
var computeGeoKde = /*#__PURE__*/ (function () {
  var _ref4 = _asyncToGenerator(
    /*#__PURE__*/ _regenerator().m(function _callee(vertexGeoCoords) {
      var _navigator;
      var data,
        _ref5,
        _ref5$lngAccessor,
        ...
        while (1)
          switch (_context.n) {
            case 0:
              ...
              (_ref5 = _args.length > 2 && _args[2] !== undefined ? _args[2] : {}),
                (_ref5$lngAccessor = _ref5.lngAccessor),
                (lngAccessor =
                  _ref5$lngAccessor === void 0
                    ? function (d) {
                        return d[0];
                      }
                    : _ref5$lngAccessor),
                (_ref5$latAccessor = _ref5.latAccessor),
                (latAccessor =
                  _ref5$latAccessor === void 0
                    ? function (d) {
                        return d[1];
                      }
                    : _ref5$latAccessor),
                (_ref5$weightAccessor = _ref5.weightAccessor),
                (weightAccessor =
                  _ref5$weightAccessor === void 0
                    ? function () {
                        return 1;
                      }
                    : _ref5$weightAccessor),
                (bandwidth = _ref5.bandwidth);
              ...
              return _context.a(
                2,
                vertexGeoCoords.map(function (coords) {
            ...
            case 1:
              ...
              geoDistance = function geoDistance(a, b) {
                ...
                return _float(2).mul(
                  asin(
                    sqrt(
                      hav(latB.sub(latA)).add(
                        cos(latA)
                          .mul(cos(latB))
                          .mul(hav(lngB.sub(lngA))),
                      ),
                    ),
                  ),
                );
  ...
  init: function init(threeObj, state, _ref) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var obj = new THREE$c.Mesh(
        new THREE$c.SphereGeometry(GLOBE_RADIUS),
        applyShaderExtensionToMaterial(
          new THREE$c.MeshLambertMaterial({
            vertexColors: true,
            transparent: true,
          }),
        ...
        computeGeoKde(vertexGeoCoords, pnts, {
          ...
          var applyUpdate = function applyUpdate(td) {
            ...
            var rScale = scaleLinear(
              [0, maxVal],
              [GLOBE_RADIUS * (1 + baseAlt), GLOBE_RADIUS * (1 + (topAlt || baseAlt))],
            );
...
var PolygonsLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    state.dataMapper
      .onUpdateObj(function (obj, _ref2) {
        ...
        if (
          addStroke &&
          (!strokeObj.geometry.parameters ||
            strokeObj.geometry.parameters.geoJson.coordinates !== coords ||
            strokeObj.geometry.parameters.resolution !== capCurvatureResolution)
        ) {
        ...
        [
          [!sideMaterial && sideColor, sideIdx],
          [!capMaterial && capColor, capIdx],
        ...
        if (
          ...
          if (
            ...
            currentTargetD.alt === targetD.alt
          ) {
            // set final position
            applyUpdate(targetD);
          } else {
  ...
  init: function init(threeObj, state, _ref) {
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      var obj = new THREE$a.Mesh(
        undefined,
        new THREE$a.MeshLambertMaterial({
                  ...
                  hexBins.map(function (h) {
                    ...
                    if (useDots) {
                      ...
                      var r =
                        0.85 *
                        (1 - margin) *
                        new THREE$a.Vector3(centerPos.x, centerPos.y, centerPos.z).distanceTo(
                          new THREE$a.Vector3(edgePos.x, edgePos.y, edgePos.z),
                        );
                      ...
                      var _geoJson =
                        margin === 0
                          ? h.hexGeoJson
                          : h.hexGeoJson.map(function (_ref2) {
                              var _ref3 = _slicedToArray(_ref2, 2),
                                elng = _ref3[0],
                                elat = _ref3[1];
                              return [
...
var PathsLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    state.dataMapper
      .onUpdateObj(function (group, path) {
        ...
        var pointsInterpolator = interpolateVectors(
          (group.__currentTargetD && group.__currentTargetD.points) || [points[0]],
          points,
        );
        var applyUpdate = function applyUpdate(td) {
          var _group$__currentTarge = (group.__currentTargetD = td),
    ...
    state.dataMapper
      .onUpdateObj(function (obj, d) {
        ...
        var applyPosition = function applyPosition(td) {
          ...
          obj.geometry && obj.geometry.dispose();
          obj.geometry = new THREE$7.SphereGeometry(
            GLOBE_RADIUS * (1 + alt),
...
var ParticlesLayerKapsule = Kapsule({
    ...
    state.dataMapper = new ThreeDigest(threeObj, {
      ...
      .onUpdateObj(function (obj, d) {
        ...
        obj.geometry.setAttribute(
          'position',
          array2BufferAttr(
            particlesListAccessor(d).map(function (p) {
  ...
  update: function update(state, changedProps) {
    if (
      ['particlesData', 'particlesList', 'particleLat', 'particleLng', 'particleAltitude'].some(function (p) {
      ...
      state.dataMapper
        ...
        .forEach(function (_ref4) {
          ...
          if ((obj.__nextRingTime || 0) <= time) {
            ...
            var circleObj = new THREE$4.Line(
              new CircleLineGeometry(1, state.ringResolution),
              new THREE$4.LineBasicMaterial(),
            );
...
var ObjectsLayerKapsule = Kapsule({
  ...
  update: function update(state, changedProps) {
    ...
    state.dataMapper
      .onUpdateObj(function (objG, d) {
        var lat = +latAccessor(d);
        var lng = +lngAccessor(d);
        var alt = +altitudeAccessor(d);
        Object.assign(objG.position, polar2Cartesian(lat, lng, alt));
        parallelAccessor(d)
          ? objG.setRotationFromEuler(new Euler(deg2Rad$1(-lat), deg2Rad$1(lng), 0, 'YXZ'))
...
var linkedGlobeLayerMethods = Object.assign.apply(
  Object,
  _toConsumableArray(
    ['globeMaterial'].map(function (p) {
...
var linkedHeatmapsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      'heatmapsData',
...
var linkedTilesLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      'tilesData',
...
var linkedParticlesLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      'particlesData',
...
var linkedRingsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      'ringsData',
...
var linkedObjectsLayerProps = Object.assign.apply(
  Object,
  _toConsumableArray(
    [
      'objectsData',
  ...
  methods: _objectSpread2(
    {
      ...
      setPointOfView: function setPointOfView(state, camera) {
        ...
        if (state.scene && globalPov) {
          ...
          isBehindGlobe = function isBehindGlobe(pos) {
            ...
            var povPosAngle = Math.acos(
              (Math.pow(povDist, 2) + Math.pow(povPosDist, 2) - Math.pow(posDist, 2)) / (2 * povDist * povPosDist),
            ); // triangle solver
      ...
      pauseAnimation: function pauseAnimation(state) {
        ...
        state.pausableLayers.forEach(function (l) {
          ...
          return (_l$pauseAnimation = l.pauseAnimation) === null || _l$pauseAnimation === void 0
            ? void 0
            : _l$pauseAnimation.call(l);
        });
        return this;
      },
      resumeAnimation: function resumeAnimation(state) {
        ...
        state.pausableLayers.forEach(function (l) {
          ...
          return (_l$resumeAnimation = l.resumeAnimation) === null || _l$resumeAnimation === void 0
            ? void 0
            : _l$resumeAnimation.call(l);
        });
        return this;
      },
...
function fromKapsule(kapsule) {
  ...
  var Globe = /*#__PURE__*/ (function (_baseClass) {
    function Globe() {
      ...
      _this.__kapsuleInstance = _construct(
        kapsule,
        [].concat(_toConsumableArray(initKapsuleWithSelf ? [_this] : []), args),
      );
      return _this;
    }
